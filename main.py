...
DEFAULT_ADMIN_CONFIG: Dict[str, Any] = {
    ...
    "pregonero_max_mentions_per_message": 35,
...
async def send_pregonero(context: ContextTypes.DEFAULT_TYPE, chat_id: int, *, title: str = "📣 <b>EL PLAN TE LLAMA</b>") -> None:
    ...
    if not mentions:
        ...
        return
    max_per_message = int(cfg_value(chat_id, "pregonero_max_mentions_per_message", 35) or 35)
    max_per_message = max(5, min(50, max_per_message))
...
def admin_private_main_markup(chat_id: int) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🔇 Silenciados", callback_data=f"cfg|muted|{chat_id}"), InlineKeyboardButton("🚪 Entradas", callback_data=f"cfg|entries|{chat_id}")],
...
def build_application() -> Application:
    ...
    application.add_handler(command_handler(["plan", "admin", "paneladmin"], admin_command))
