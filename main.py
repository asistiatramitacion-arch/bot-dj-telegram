...
class ChatState:
    ...
    panel_message_id: Optional[int] = None          # mensaje fijado arriba
    control_message_id: Optional[int] = None        # cuadro de mandos
    paused: bool = False
...
def control_panel_text(state: ChatState) -> str:
    ...
    if state.now_playing:
        ...
        current_title = current.title[:40]
